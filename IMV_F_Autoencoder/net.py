...
class SOSMaskFuse_autoencoder(nn.Module):
    def __init__(self, nb_filter, input_nc=1, output_nc=1):
        super(SOSMaskFuse_autoencoder, self).__init__()
    ...
    def IMV_F_fusion_strategy(self, en_ir_a, en_ir_b, en_vi_a, en_vi_b):
        # Separate fusion of salient objects and backgrounds
        salient_background_fusion = IMV_F().Salient_Background_Fusion
        f1_0, f2_0, f3_0, f4_0 = salient_background_fusion(en_ir_a, en_ir_b, en_vi_a, en_vi_b)
